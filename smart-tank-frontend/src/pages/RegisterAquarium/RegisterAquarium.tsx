...
const RegisterAquarium = () => {
  // Form state - Matches API specification exactly
    ...
    <>
      ...
      >
        ...
        <Container maxWidth="lg" sx={{ position: "relative", zIndex: 2 }}>
          ...
          >
            Join our network of trusted aquarium retailers and reach more
            customers
          </Typography>
        </Container>
      </Box>
      ...
      >
        <Container maxWidth="lg">
          <Box sx={{ textAlign: "center", mb: 4 }}>
            ...
            >
              Please fill out all required information to register your aquarium
            ...
            >
              ...
              {!isFormValid() && (
                ...
                >
                  ...
                  >
                    ⚠️ Please complete all required fields including aquarium
                    name, personal details (first name, last name, email,
                    phone), business information (business name & registration
                    number), complete address with province and postal code,
                    upload the fish list document, and agree to the terms &
                    conditions
                  </Typography>
                </Box>
              )}
